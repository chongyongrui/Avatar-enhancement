...
// namespace IndyWallet{
//     public class WriteDIDAndQueryVerkey
//     {
//         public static void WriteDID(Dictionary<string, string> arguments)
//         {

//             Console.WriteLine("Step 1 -- set up some constants");

//             string walletName = arguments["WalletName"];
//             string poolName = "pool";
//             string stewardSeed = arguments["Seed"];
...
//             Wallet.CreateWalletAsync(poolName, walletName);

//             Console.WriteLine("          Open identity wallet and get the wallet handle from libindy.");
//             Wallet wallet = Wallet.OpenWalletAsync(walletName, string.Empty).Result;
